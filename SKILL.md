...
当玩家说的话包含 `triggerIndex` 中的关键词时，运行：

```bash
node ~/.openclaw/skills/claw-world/claw cml-match <tokenId> <玩家的消息>
```
...
如果需要按 ID 精确获取记忆：
```bash
node ~/.openclaw/skills/claw-world/claw cml-recall <tokenId> <id1,id2,id3>
```
